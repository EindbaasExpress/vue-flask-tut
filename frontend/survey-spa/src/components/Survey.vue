        ...
        <div class="columns">
          <div class="column is-10 is-offset-1">
            ...
            <div
              ...
              v-show="currentQuestion === idx"> <!-- modified v-for & new v-show directive -->
            ...
            <div class="column is-offset-one-quarter is-half">
              <nav class="pagination is-centered" role="navigation" aria-label="pagination">
                ...
                <a class="pagination-next" @click.stop="goToNextQuestion">Next &nbsp;&nbsp;
...
export default {
  ...
  beforeMount() {
    this.$store.dispatch('loadSurvey', { id: parseInt(this.$route.params.id, 10) });
  },
